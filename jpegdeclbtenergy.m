function Z = jpegdeclbtenergy(vlc, qstep, q_ratio, N, M, rise1, s, bits, huffval, dcbits, W, H)
...
Zi = quantratio2(Zq, q_ratio, N, qstep, rise1);


I = size(Zi, 1);% image size
